...
{
    public partial class FormFloydDieuKhienChay : DevExpress.XtraEditors.XtraForm
    {
        private List<DoThi> listDoThi = new List<DoThi>();
        private int index = 0;
        
        public FormFloydDieuKhienChay()
        {
            InitializeComponent();
        }
        private void LoadDgvDinh()
        {
            dataGridView1.ColumnCount = Data.Data.graph_Floyd.dsDinh.Count+1;
            dataGridView1.Columns[0].Name = "Khởi tạo";
            for (int i = 1; i < Data.Data.graph_Floyd.dsDinh.Count+1; i++)
            {
                dataGridView1.Columns[i].Name = Data.Data.graph_Floyd.dsDinh[i-1].Ten;
            }
        }    
        private void OnLoad()
        {
        ...
        {
            ///  cbx Xuat Phat
            cbxDinhXuatPhat.Properties.DataSource = Data.Data.graph_Floyd.dsDinh.ToList();
            cbxDinhXuatPhat.Properties.DisplayMember = "Ten";
            cbxDinhXuatPhat.Properties.ValueMember = "ID";

            // cbx ket thuc
            cbxDinhKetThuc.Properties.DataSource = Data.Data.graph_Floyd.dsDinh.ToList();
        ...
        private void FormFloydDieuKhienChay_Load(object sender, EventArgs e)
        {
            OnLoad();
            LoadInitControl();
            index = 0;
        ...
        private void HienThiDoThi()
        {
            ...
            try
            {
                ...
                for (int i=0; i< Data.Data.graph_Floyd.dsDinh.Count;i++)
                {
        ...
        private void btnStartChayTuDong_Click(object sender, EventArgs e)
        {
            if (Check())
            {
                ...
                listDoThi = FloydWarshall.Run(Data.Data.graph_Floyd, (int)cbxDinhXuatPhat.EditValue, (int)cbxDinhKetThuc.EditValue);
                index = 0;
                timer1.Enabled = true;
